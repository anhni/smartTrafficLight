...
void uart_isr_simulate_machine()
{
    ...
    {
        case WAIT_HEADER_1:
            LcdPrintStringS(0,0,"UART MODE: ON");
            if(countReceive == 0){
                UartSendString("\r\n");
                UartSendString("-----------------\r\n");
            ...
            if (tempReceive == 97){
                ...
                UartSendString("press d to come back to traffic mode!\r\n");
                trafficMode = 1;
        ...
        case RECEIVE_DATA_X1:
            ...
            if(enable_flag == 0 || (tempReceive >= 48 && 57 >= tempReceive)){
                if(tempReceive >= 48 && 57 >= tempReceive){
                    ...
                    LcdPrintNumS(1,4,dataReceive[0]); 
                    UartSendString("-----------------\r\n");
        ...
        case RECEIVE_DATA_Y2:
            ...
            if(enable_flag == 0 || (tempReceive >= 48 && 57 >= tempReceive)){
                if(tempReceive >= 48 && 57 >= tempReceive){
                    ...
                    UartSendString("Reupdate Y2 or press a to countinue\r\n");
                    enable_flag = 1;
                }else{
                    UartSendString(" => Wrong value \r\n");
                    UartSendString("Update Y2:");
        ...
        case END_OF_RECEIVE_1:
            if (tempReceive == 97)
            {
                ...
                UartSendString("\r\n");
                UartSendString("Waiting for changing to mode...\r\n");
            }
            else if (tempReceive == 98){
                statusReceive = WAIT_HEADER_1;
        ...
        case MANUAL_0:
            ...
            else if (tempReceive == 100){
                timeDelay = 0;
                enable = 0;
                UartSendString("\r\nWaiting for changing to mode...\r\n");
                manualMode = 5;      
                statusReceive = WAIT_HEADER_1;
            } 
            break;
